...
function draw() {
    ...
    if(stroke === null) {
        stroke(255,0,0);
        textSize(18);
        text("ERROR PLZ SELECT A COLOR FOR DRAWING",innerWidth/2,innerHeight/2);
    }
}
